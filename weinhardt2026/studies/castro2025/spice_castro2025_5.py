...
class SpiceModel(BaseModel):
    """
    v5: v4 (learnable initial values) + env reward tracking from v2.

    Adds back value_reward_env: a global reward tracker (no action_mask)
    whose output feeds into both chosen and unchosen reward modules.
    Combined with v3's action[t-1] for choice and v4's learnable prior.

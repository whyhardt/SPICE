...
class SpiceModel(BaseModel):
    """
    v6b: bias_5 - exploration_not_chosen.

    Drops the exploration module for unchosen items. Exploration only
    reacts to prediction errors on the chosen item.

    7 modules, 4 logit states.
    """
    ...
    def forward(self, inputs, state=None):
        ...
        for trial in spice_signals.trials:
            ...
            # --- EXPLORATION VALUE UPDATES (chosen only) ---

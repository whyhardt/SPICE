...
class SpiceModel(BaseModel):
    """
    v3.2: v3 + directional dvalue decomposition.

    Replaces scalar dvalue with (dvalue_pos, dvalue_neg) = (relu(dvalue), relu(-dvalue))
    in the exploration modules. This gives SINDy fully independent polynomial
    responses for positive vs. negative reward changes, enabling asymmetric
    exploration dynamics (e.g. stronger exploration after losses than gains).

...
from weinhardt2026.studies.castro2025.spice_castro2025 import SpiceModel, CONFIG
...
from weinhardt2026.studies.castro2025.analysis_generative import analysis_generative_behavior
...
path_data = 'weinhardt2026/studies/castro2025/data/eckstein2024.csv'
test_blocks = (2,)
...
path_spice = 'weinhardt2026/studies/castro2025/params/spice_castro2025.pkl'
...
path_cfs = 'weinhardt2026/studies/castro2025/params/cfs_castro2025.pkl'
...
if train_cfs:
    optimizer = torch.optim.Adam(params=cfs.parameters(), lr=0.01)
    cfs = training(
        model=cfs, optimizer=optimizer,
        dataset_train=dataset_train, dataset_test=dataset_test,
        epochs=1000, loss_kwargs={'label_smoothing': 0.0},
    )
...
path_gru = 'weinhardt2026/studies/castro2025/params/gru_castro2025.pkl'
...
print(analysis_model_evaluation(
    ...
    benchmark_model=cfs.to(torch.device('cpu')),
    gru_model=gru.eval().to(torch.device('cpu')),
    output_dir='weinhardt2026/studies/castro2025/results',
))
...
data_dir = 'weinhardt2026/studies/castro2025/data'
output_dir = 'weinhardt2026/studies/castro2025/results'

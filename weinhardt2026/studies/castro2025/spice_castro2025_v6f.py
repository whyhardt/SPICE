...
class SpiceModel(BaseModel):
    """
    v6f: merged choice with spatial absorbed, split exploration, no LA.

    Single value_choice module receives action[t], action[t-1], is_adjacent,
    is_opposite. Spatial bias is entangled with choice persistence in one
    state. No separate attention module.

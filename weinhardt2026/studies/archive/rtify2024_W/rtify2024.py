...
epochs=0  # enables stage 1 training; if epochs=0 -> load existing model from path_spice
...
plot_participant_fit(estimator, dataset_test, dt, t_max, participant_id=0, use_sindy=False, output_path=None)
plot_participant_fit(estimator, dataset_test, dt, t_max, participant_id=1, use_sindy=False, output_path=None)
plot_participant_fit(estimator, dataset_test, dt, t_max, participant_id=2, use_sindy=False, output_path=None)

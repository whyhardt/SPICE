"""eckstein2026 variant s4_readd_exploration_unchosen: Step 4: final model with unchosen exploration module added back.
...
CONFIG = SpiceConfig(
    library_setup={
        ...
        'value_exploration_not_chosen': ['dvalue_pos', 'dvalue_neg'],
...
class SpiceModel(BaseModel):
    """Step 4: final model with unchosen exploration module added back."""

...
class SpiceModel(BaseModel):
    """
    Legacy architecture with a single merged value_choice module; kept so the
    checkpoints trained before the chosen/not-chosen choice split stay loadable
    (params/spice_eckstein2026.pkl and the stability runs in params/params/).

"""eckstein2026 variant m16_expl_signed_chosen_only: Step 1 arm: signed dvalue exploration on the chosen item only; reward modules without env and mean.
...
class SpiceModel(BaseModel):
    """Step 1 arm: signed dvalue exploration on the chosen item only; reward modules without env and mean."""

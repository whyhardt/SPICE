"""eckstein2026 variant m13_expl_split_no_env: Step 1 arm: split dvalue exploration, reward modules without env and mean inputs.
...
class SpiceModel(BaseModel):
    """Step 1 arm: split dvalue exploration, reward modules without env and mean inputs."""

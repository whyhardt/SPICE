"""eckstein2026 variant m15_expl_split_chosen_only: Step 1 arm: split dvalue exploration on the chosen item only; reward modules without env and mean.
...
class SpiceModel(BaseModel):
    """Step 1 arm: split dvalue exploration on the chosen item only; reward modules without env and mean."""

"""eckstein2026 variant s4_readd_exploration: Step 4: final model with exploration modules added back.
...
class SpiceModel(BaseModel):
    """Step 4: final model with exploration modules added back."""

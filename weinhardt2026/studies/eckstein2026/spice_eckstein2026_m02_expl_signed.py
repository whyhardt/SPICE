"""eckstein2026 variant m02_expl_signed: m01 with exploration driven by the signed value change dvalue.
...
class SpiceModel(BaseModel):
    """m01 with exploration driven by the signed value change dvalue."""

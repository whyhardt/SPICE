"""eckstein2026 variant m06_no_exploration: m01 without exploration modules.
...
CONFIG = SpiceConfig(
    ...
    states_in_logit=['value_reward_env', 'value_reward', 'value_choice', 'bias_attention'],
)
...
class SpiceModel(BaseModel):
    """m01 without exploration modules."""

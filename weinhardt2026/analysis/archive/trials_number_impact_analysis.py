...
from weinhardt2026.utils.bandits import BanditsDrift, create_dataset as create_dataset_bandits
...
def run_training_and_evaluation(dataset, label):
    ...
    for pid in sorted(available_participant_ids):
        ...
        choices_np = xs_participant[..., :agent_sindy.n_actions].cpu().numpy().squeeze(0)

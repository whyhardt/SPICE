...
class SpiceModel(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.setup_module(key_module='value_reward_chosen', input_size=2)
        self.setup_module(key_module='value_reward_not_chosen', input_size=1)
        self.setup_module(key_module='value_choice_chosen', input_size=1)
        self.setup_module(key_module='value_choice_not_chosen', input_size=1)

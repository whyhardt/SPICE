...
class SpiceModel(BaseRNN):
    ...
    def __init__(self, **kwargs):
        ...
        self.setup_module(key_module='value_reward_chosen', input_size=5+self.embedding_size, dropout=dropout)  # -> 21 terms
        self.setup_module(key_module='value_reward_not_chosen', input_size=5+self.embedding_size, dropout=dropout)  # -> 21 terms
        self.setup_module(key_module='value_choice', input_size=5+self.embedding_size, dropout=dropout, include_bias=False) # -> 21 terms; bias not necessary when module is applied equally to all options
    ...
    def forward(self, inputs, prev_state=None, batch_first=False):
        ...
        for trial in spice_signals.trials:
            ...
            actions_t = spice_signals.actions[trial]
            rewards_t = spice_signals.rewards[trial]
            ...
            self.call_module(
                ...
                inputs=(
                    # rewards_t,
                    rewards_chosen_success[trial],
                    rewards_chosen_fail[trial],

...
class SpiceModel(BaseModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.setup_module(key_module='value_reward_not_chosen', input_size=4, dropout=dropout)  # -> 21 terms
        self.setup_module(key_module='value_choice', input_size=4, dropout=dropout) # -> 21 terms; bias not necessary when module is applied equally to all options

...
class SpiceModel(BaseModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.setup_module(key_module='value_reward_chosen', input_size=4)  # -> 21 terms
        self.setup_module(key_module='value_reward_not_chosen', input_size=3)  # -> 15 terms
        self.setup_module(key_module='value_reward_not_displayed', input_size=3)  # -> 15 terms
        self.setup_module(key_module='value_choice_chosen', input_size=3) # -> 15 terms
        self.setup_module(key_module='value_choice_not_chosen', input_size=3) # -> 15 terms -> 21+15+15+15 = 66 terms in total
        self.setup_module(key_module='value_choice_not_displayed', input_size=3) # -> 15 terms -> 21+15+15+15 = 66 terms in total

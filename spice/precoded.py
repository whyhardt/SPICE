...
class RescorlaWagnerRNN(BaseRNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(RescorlaWagnerRNN, self).__init__(n_actions=n_actions, list_signals=RESCOLA_WAGNER_CONFIG.spice_feature_list)
...
class ForgettingRNN(BaseRNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(ForgettingRNN, self).__init__(n_actions=n_actions, list_signals=FORGETTING_RNN_CONFIG.spice_feature_list)
...
class LearningRateRNN(BaseRNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(LearningRateRNN, self).__init__(n_actions=n_actions, list_signals=LEARNING_RATE_RNN_CONFIG.spice_feature_list)
...
class ParticipantEmbeddingRNN(BaseRNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(ParticipantEmbeddingRNN, self).__init__(n_actions=n_actions, list_signals=LEARNING_RATE_RNN_CONFIG.spice_feature_list)
...
class Weinhardt2024RNN(BaseRNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Weinhardt2024RNN, self).__init__(n_actions=n_actions, list_signals=WEINHARDT_2024_CONFIG.spice_feature_list)
